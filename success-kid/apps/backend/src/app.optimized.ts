...
import { registerCompressionMiddleware } from './middleware/compression-middleware';
...
export async function buildApp(options = {}): Promise<FastifyInstance> {
  ...
  await app.register(compress, {
    global: false, // We'll control compression through our middleware
    encodings: ['gzip', 'deflate']
  });

  // Register custom compression middleware for optimal control
