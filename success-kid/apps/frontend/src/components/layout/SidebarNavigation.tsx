...
/**
 * SidebarNavigation - Desktop sidebar navigation component with professional animations
 * Provides collapsible sidebar with top and bottom navigation sections
 */
...
function NavItem({ 
  ...
  const itemVariants = {
    ...
    collapsed: { 
      opacity: 0, 
      x: -10,
      transition: { duration: 0.2, ease: bezierCurves?.exit || [0.4, 0.0, 0.2, 1] }
    }
  };
