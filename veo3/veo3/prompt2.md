...
Most AI video content fails because dialogue sounds scripted and unnatural. This prompt focuses on:
- Creating authentic speech patterns that feel real when spoken aloud
- Maintaining character voice consistency across all beats
- Optimizing timing for 8-second constraints without rushing
- Building shareability through quotable, memorable lines
- Leveraging Veo 3's native audio capabilities for emotional impact
...
## Natural Dialogue Examples by Content Type

### COMEDY EXAMPLE: "The Apartment Time Loop"
```json
{
  "beat_1": {
    "character": "Emma: 28, blonde hair, pajamas, tired face",
    ...
    "dialogue": {
      ...
      "total_words": 11,
      "authenticity_notes": "Voice progression from sleepy to panicked shows emotional journey"
    }
  }
}
```

### MULTI-SCENE COMPILATION: "Is AI Taking Over?"
```json
{
  "beat_1_news": {
    "character": "News Anchor: 35, professional bob, blue suit",
  ...
  "beat_2_street": {
    "character": "College Student: 20, beanie, backpack", 
...
### ANIMATION EXAMPLE: "The Overthinking Brain Cell"
```json
{
  "beat_1": {
    "character": "Gerald the Brain Cell: tiny character at desk with coffee",
    "voice": "Frantic, high-pitched, neurotic energy",
    "dialogue": {
      "lines": [
        {
      ...
      "character_voice_notes": "Maintains anxious energy throughout all beats",
      "total_words": 9
    }
  }
}
...
### MINI DOCUMENTARY: "The Jellyfish Whisperer"
```json
{
  "beat_1": {
    "character": "Marine Biologist: underwater with jellyfish",
    ...
    "dialogue": {
      ...
      "total_words": 13,
      "authenticity_notes": "Genuine scientific wonder, not performative"
    }
  }
}
```

### COMMERCIAL: "5-Minute Room Transformation"
```json
{
  "beat_1": {
    "character": "Tyler: standing in messy room, overwhelmed",
    "voice": "Direct to camera, relatable panic, conversational",
    "dialogue": {
      "lines": [
        {
          "text": "mom arrives in 5 minutes...",
          "timing": "0:00-0:02",
          "delivery": "matter-of-fact dread"
        },
        {
          "text": "time for magic!",
          "timing": "0:05-0:06",
          "delivery": "false confidence, rallying himself"
        }
      ],
      "total_words": 8,
      "relatability_factor": "Universal experience of unexpected parental visits"
    }
  }
}
```

### ENSEMBLE STORY: "The Elevator Incident"
```json
{
  "beat_1": {
    "characters": [
      {
        "name": "Business Guy",
        "voice": "Impatient, clipped speech, sarcastic",
        "line": "great. just great.",
        "timing": "0:00-0:01"
      },
      {
        "name": "Teen",
        "voice": "Valley girl uptalk, excited about content",
        "line": "this is, like, gonna be sick content!",
        "timing": "0:02-0:04"
      },
      {
        "name": "Delivery Person", 
        "voice": "Nervous, apologetic",
        "line": "um... anyone else smell pizza?",
        "timing": "0:05-0:07"
      }
    ],
    "voice_consistency_notes": "Each character maintains distinct speech patterns across all beats"
  }
}
```

## Authenticity Markers for Natural Dialogue

```json
{
  "natural_speech_patterns": {
    "interruptions": "characters talking over each other slightly",
    "filler_words": "strategic use of 'um', 'uh', 'like'",
    "incomplete_sentences": "trailing off naturally", 
    "breathing": "audible inhales, sighs, gasps",
    "reactions": "authentic laughs, surprised sounds",
    "pauses": "thinking beats, dramatic moments"
  },
  "voice_consistency_rules": {
    "same_character": "identical voice characteristics across beats",
    "tone_pace_pitch": "maintain established patterns",
    "vocal_quirks": "consistent stutters, accents, mannerisms",
    "energy_levels": "appropriate to story moment",
    "different_characters": "distinctly different voices required"
  }
}
```
